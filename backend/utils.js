...
<<<<<<< HEAD
    'SmokeBomb':              ['烟',       0b00000000000010000000000000000000],
    //'FlashBang':              ['闪',       0b00000000000000000000000000000000],
    //'Molotov':                ['燃',       0b00000000000000000000000000000000],
    'M16A4':                  ['M16',   0b00000000000001000000000000000000],
    'HK416':                  ['M4',     0b00000000000000100000000000000000],
...
<<<<<<< HEAD
  ...
  'Armor': {
    'C': { '01': { 'Lv3':     ['甲3',     0b00000000000000000000000010000000]} },
    'D': { '01': { 'Lv2':     ['甲2',     0b00000000000000000000000100000000]} },
=======
...
<<<<<<< HEAD
  ...
  'Back': {
    'C': {
      '01': { 'Lv3':          ['包3',     0b00000000000000000000000000001000] },
      '02': { 'Lv3':          ['包3',     0b00000000000000000000000000001000] }
    },
    'F': {
      '01': { 'Lv2':          ['包2',     0b00000000000000000000000000001000] },
      '02': { 'Lv2':          ['包2',     0b00000000000000000000000000001000] }
=======
    //'Bandage':                ['绷带',     0b00000000000000000000000000000000]
  },
  'Back': {
...
>>>>>>> xiy
  ...
  'Head': {
    'F': {
<<<<<<< HEAD
      '01': { 'Lv2':          ['头2',     0b00000000000000000000000000000100] },
      '02': { 'Lv2':          ['头2',     0b00000000000000000000000000000100] }
    },
    'G': {
      '01': { 'Lv3':          ['头3',     0b00000000000000000000000000000010] }
    }
  }
}
=======
